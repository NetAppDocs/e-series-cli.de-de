...
---
= SANtricity CLI-Administratorbefehle
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Die folgende Liste von Administratorbefehlen steht für das Storage-System der E-Series zur Verfügung.
...
link:../commands-a-z/show-storagearray-autosupport.html["Zeigt die AutoSupport-Konfiguration an"]
