...
summary: Der Befehl storageArray pqValidateOnReconstruct set legt den P/Q-Validierungsstatus des Speicherarrays bei der Rekonstruktion fest. Wenn diese Funktion aktiviert ist, werden die Daten unter Verwendung sowohl von Daten P als auch von Daten Q rekonstruiert und die Ergebnisse auf Konsistenz geprüft, bevor über das weitere Vorgehen entschieden wird. 
---
...
Um diesen Befehl auf einem E4000, 2800, E5700, EF600, EF300, EF50 oder EF80 Storage-Array auszuführen, müssen Sie die Storage Admin-Rolle haben.
