...
summary: Der Befehl set snapVolume convertToReadWrite ändert ein Snapshot Volume, das ein schreibgeschütztes Volume ist, in ein Snapshot Volume, das ein beschreibbares Volume ist. 
---
