...
summary: Mit dem Befehl Laufwerk starten wird eine Laufwerkinitialisierung gestartet. 
---
= Laufwerksinitialisierung starten – SANtricity CLI
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Der `start drive initialize` Befehl startet eine Laufwerkinitialisierung.
...
[NOTE]
====
*Mögliche Schäden an der Konfiguration des Speicherarrays* -- Sobald Sie diesen Befehl eingeben, werden alle Benutzerdaten zerstört.
