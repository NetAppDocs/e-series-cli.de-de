...
summary: 'Der Befehl „set controller hostPort“ ändert die Netzwerkeigenschaften für die folgenden Typen von Host-Ports: iSCSI, iSER, NVMe over InfiniBand und NVMe over RoCE. Zu den Eigenschaftsänderungen gehören IPv4- und IPv6-Eigenschaften, die Port-Geschwindigkeit und die maximale Frame-Nutzlast.' 
---
