...
Jeder Bandname muss eindeutig sein. Für die Benutzerbezeichnung sind beliebige Kombinationen aus alphanumerischen Zeichen, Unterstrich (_), Bindestrich (-) und Raute (#) zulässig. Standard und Thin Volume Namen dürfen maximal 60 Zeichen lang sein.
