...
summary: Der SMcli enable disable autoSupportRemoteDiag Befehl aktiviert oder deaktiviert die AutoSupport Remote Diagnostics Funktion. Mit dieser Funktion kann der technische Support Supportdaten anfordern, um Probleme aus der Ferne zu diagnostizieren. 
---
