...
summary: Der SMcli enable disable autoSupportOnDemand Befehl aktiviert oder deaktiviert die AutoSupport OnDemand Funktion. Diese Funktion ermöglicht dem technischen Support, die Übertragung von AutoSupport Daten zu koordinieren und die erneute Übermittlung fehlender Supportdaten anzufordern. 
---
