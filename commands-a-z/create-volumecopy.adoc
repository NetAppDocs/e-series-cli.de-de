...
Für die Namen können beliebige alphanumerische Zeichen, Bindestriche und Unterstriche verwendet werden. Standard- und Thin-Volume-Namen dürfen maximal 60 Zeichen lang sein.
