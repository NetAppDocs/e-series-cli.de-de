...
summary: Mit dem Befehl Revive Drive wird das angegebene Laufwerk in den optimalen Zustand versetzt. 
---
= Laufwerk wiederbeleben - SANtricity CLI
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Der `revive drive` Der Befehl zwingt das angegebene Laufwerk zum optimalen Status.
