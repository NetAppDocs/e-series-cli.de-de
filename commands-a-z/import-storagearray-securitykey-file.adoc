...
Wenn die externe Schlüsselverwaltung aktiviert ist, gilt dieser Befehl nur für die Arrays E4000, E2800, E5700, EF600, EF300, EF50 oder EF80. Wenn die interne Schlüsselverwaltung aktiviert ist, gilt der Befehl für jedes einzelne Speicher-Array, sofern alle SMcli Pakete installiert sind.
