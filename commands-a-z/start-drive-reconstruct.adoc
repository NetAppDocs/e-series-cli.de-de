...
summary: Der Befehl Start Drive reconstruct beginnt mit der Wiederherstellung eines Laufwerks. 
---
= Laufwerksrekonstruktion starten – SANtricity CLI
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Der `start drive reconstruct` Befehl startet die Wiederherstellung eines Laufwerks.
