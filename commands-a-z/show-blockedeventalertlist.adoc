...
summary: Der Befehl show blockedEventAlertList gibt eine Liste von Ereignissen zurück, die derzeit durch den Befehl set blockEventAlert blockiert sind. Die Ereignisse in dieser Liste sind diejenigen Ereignisse, die keine Benachrichtigungen senden, die Sie mithilfe der Alarm-Terminals und -Parameter konfiguriert haben, d. h. E-Mail-, Syslog- und Trap-Benachrichtigungen. 
---
