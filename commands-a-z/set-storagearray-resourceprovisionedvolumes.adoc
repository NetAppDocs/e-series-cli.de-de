...
[NOTE]
====
Die Spiegelung eines Volumes kann nicht eingerichtet werden, solange DULBE aktiviert ist. Für die Verwendung der Spiegelung muss  `resourceProvisionedVolumes` auf  `disable` gesetzt werden.
