...
Für die Namen kann jede Kombination aus alphanumerischen Zeichen, Unterstrich (_), Bindestrich (-) und Raute (#) verwendet werden. Standard- und Thin-Volume-Namen dürfen maximal 60 Zeichen enthalten, alle anderen Komponentennamen maximal 30 Zeichen.
