...
Um diesen Befehl auf einem E4000, E2800, E5700, EF600, EF300, EF50 oder EF80 Speicherarray auszuführen, müssen Sie die Storage Admin Rolle haben. Die Verwendung dieses Befehls mit dem LDAP-Parameter ist jedoch auf Benutzer mit der Security Admin Rolle beschränkt.
