...
Die folgende Tabelle listet die Änderungen an den CLI- und Skriptbefehlen für Release 12.10 auf.
...
| Befehl | Beschreibung der Änderung 
 ...
 a| 
https://docs.netapp.com/us-en/e-series-cli/commands-a-z/set-storagearray-host-io-protocol.html["Speicherarray-Host-I/O-Protokoll festlegen"]
 a| 
Option `nvmeTcp` zum Befehl hinzugefügt.



 a| 
https://docs.netapp.com/us-en/e-series-cli/commands-a-z/create-raid-volume-automatic-drive-select.html["Erstellen von RAID-Volumes (automatische Laufwerkauswahl)"]
 a| 
Die maximale Zeichenanzahl für den  `userLabel` Parameter wurde von 30 auf 60 Zeichen erhöht.


NOTE: Ein Downgrade von SANtricity 12.10 auf frühere Versionen wird nicht unterstützt, wenn der  `userLabel` Parameter mehr als 30 Zeichen umfasst.



 a| 
https://docs.netapp.com/us-en/e-series-cli/commands-a-z/create-raid-volume-free-extent-based-select.html["RAID-Volume erstellen (freie Erweiterungsauswahl)"]
 a| 
Die maximale Zeichenanzahl für den  `userLabel` Parameter wurde von 30 auf 60 Zeichen erhöht.
...
NOTE: Ein Downgrade von SANtricity 12.10 auf frühere Versionen wird nicht unterstützt, wenn der  `userLabel` Parameter mehr als 30 Zeichen umfasst.
 ...
 a| 
https://docs.netapp.com/us-en/e-series-cli/commands-a-z/create-raid-volume-manual-drive-select.html["Erstellen von RAID-Volumes (Auswahl manueller Laufwerke)"]
 a| 
Die maximale Zeichenanzahl für den  `userLabel` Parameter wurde von 30 auf 60 Zeichen erhöht.
...
NOTE: Ein Downgrade von SANtricity 12.10 auf frühere Versionen wird nicht unterstützt, wenn der  `userLabel` Parameter mehr als 30 Zeichen umfasst.
 ...
 a| 
https://docs.netapp.com/us-en/e-series-cli/commands-a-z/create-volume-diskpool.html["Erstellen Sie ein Volume im Festplatten-Pool"]
 a| 
Die maximale Zeichenanzahl für den  `userLabel` Parameter wurde von 30 auf 60 Zeichen erhöht.
...
NOTE: Ein Downgrade von SANtricity 12.10 auf frühere Versionen wird nicht unterstützt, wenn der  `userLabel` Parameter mehr als 30 Zeichen umfasst.
 ...
 a| 
https://docs.netapp.com/us-en/e-series-cli/commands-a-z/recover-volume.html["RAID-Volume wiederherstellen"]
 a| 
Die maximale Zeichenanzahl für den  `userLabel` Parameter wurde von 30 auf 60 Zeichen erhöht.
...
Die folgende Tabelle listet Änderungen an den CLI- und Skriptbefehlen für Release 12.00 auf.
...
Befehl hinzugefügt.
 ...
 a| 
https://docs.netapp.com/us-en/e-series-cli/commands-a-z/show-storage-array-host-io-protocol.html["Host-I/O-Protokollinformationen des Speicherarrays anzeigen"]
 a| 
Befehl hinzugefügt.
 ...
 a| 
https://docs.netapp.com/us-en/e-series-cli/commands-a-z/start-storagearray-externalkeymanagement-test.html["Testen der Kommunikation zum externen Verschlüsselungsmanagement"]
 a| 
Testergebnisse der KMS-Kommunikation zur Befehlsausgabe hinzugefügt.



 a| 
https://docs.netapp.com/us-en/e-series-cli/commands-a-z/set-storagearray-managementinterface.html["Legen Sie die Managementoberfläche für das Storage Array fest"]
 a| 
Befehl entfernt.
...
Aktualisiert `disableResourceProvisioning` Parameterbeschreibung.
 ...
 a| 
xref:./commands-a-z/recreate-storagearray-securitykey.adoc[Externen Sicherheitsschlüssel neu erstellen]
 a| 
